        ...
        <div class="row justify-content-md-center">
            <div class="col-md-8">
                ...
                >
                    ...
                    <p class="blog-post-meta">{{ article.date }}<a href="#">Mark</a></p>
            ...
            <div class="col-md-4">
                ...
                <blog-plugin>
                    ...
                    <ol class="list-unstyled">
                        <li>
                            <a 
                                href="https://github.com/dongprojectteam" 
                                target="_blank"
                            >GitHub</a>
                        </li>
                        <li>
                            <a 
                                href="https://blog.naver.com/armigar" 
                                target="_blank"
                            >Blog</a>
                        </li>
                        <li>
                            <a 
                                href="https://www.facebook.com/dongprojectteam" 
                                target="_blank"
                            >Facebook</a>
                        </li>
                    </ol>
...
export default {
    setup(){
        ...
        const onSuccess = (data) => {
            ...
            console.log("temp_group :: ",temp_group)
